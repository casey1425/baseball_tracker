...
export function Dashboard() {
  ...
  const loadDetail = useCallback(async (signal?: AbortSignal, silent = false) => {
    ...
    try {
      ...
      setRelayEntries(bundle.relayEntries);
      setBoxscore(bundle.boxscore);
        ...
        <div className="detail-workspace">
          ...
          <div className="dashboard-grid">
            <section className="main-column">
              ...
              {activeTab === "players" && <BoxscorePanel boxscore={boxscore} />}
              {activeTab === "summary" && summary && <SummaryPanel summary={summary} />}
            </section>
